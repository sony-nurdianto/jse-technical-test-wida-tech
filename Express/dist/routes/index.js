...
router.get('/invoices', invoices_controller_1.default.getInvoices);
router.get('/invoices-all', invoices_controller_1.default.getInvoicesAll);
...
router.get('/products-all', products_controller_1.default.getProductsAll);
...
router.get('/invoice-details-all', invoices_details_controller_1.default.getInvoicesDetailAll);
router.get('/invoice-details', invoices_details_controller_1.default.getInnvoicesDetail);
